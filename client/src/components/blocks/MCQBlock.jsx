...
export default function MCQBlock({ question, options, answer, explanation }) {
  ...
  return (
    <div className="my-8 rounded-2xl overflow-hidden border border-[var(--border-light)] shadow-sm">
      {/* Header */}
      <div className="bg-gradient-to-r from-[var(--accent-primary)]/10 to-[var(--accent-secondary)]/10 px-6 py-4 border-b border-[var(--border-light)]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="font-semibold text-[var(--text-primary)]">Knowledge Check</h4>
      ...
      <div className="p-6 bg-[var(--bg-card)]">
        <p className="text-lg font-medium text-[var(--text-primary)] mb-6 leading-relaxed">
          {question}
        </p>
        ...
        {/* Result */}
        {showExplanation && (
          <div className={`mt-6 p-5 rounded-xl transition-all duration-500 ${
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h5 className={`font-semibold mb-2 ${isCorrect ? 'text-[var(--success)]' : 'text-[var(--warning)]'}`}>
